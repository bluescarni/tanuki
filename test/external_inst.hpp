...
#ifndef TANUKI_TEST_EXTERNAL_INST_HPP
#define TANUKI_TEST_EXTERNAL_INST_HPP
...
extern template class FOOABLE_DLL_PUBLIC wrap<fooable::foo_iface<int>, fooable::foo_wrap_config<int>>;
